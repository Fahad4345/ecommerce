...
//                                         <button className="font-[Poppins] font-[500] text-[16px] leading-[24px] absolute bottom-0 left-0 w-full bg-black text-white py-2 text-sm translate-y-full group-hover:translate-y-0 transition-all duration-300">
//                                             Add To Cart
//                                         </button>
//                                     </div>
...
//                                             <Image src="/assets/icons/Quick View.svg" alt="" width={24} height={24} />
//                                         </button>
//                                     </div>
