        ...
        <div className='ml-[135px] mt-[145px] flex flex-col gap-[40px] items-center '>
            <div className=' flex  w-full gap-[470px]'>
                ...
                <div className='flex gap-[8px]'>
                    <button className='w-[46px] h-[46px] rounded-full justify-center items-center flex bg-[#F5F5F5] rotate-180' onClick={() => swiperRef.current?.slidePrev()}><Image src="/assets/icons/BlackRightArrow.svg" className=" " alt="" width={24} height={24} /></button>
                    <button className='w-[46px] h-[46px] bg-[#F5F5F5]  rounded-full justify-center items-center flex' onClick={() => swiperRef.current?.slideNext()}><Image src="/assets/icons/BlackRightArrow.svg" className="" alt="" width={24} height={24} /></button>
                </div>
                ...
                {products.map((product) => (
                    <SwiperSlide key={product.id}>
                        <div className="flex flex-col min-w-[270px] w-full min-h-[350px] h-full gap-[16px]">
                            <div className="relative bg-[#F5F5F5] px-[12px] py-[12px] min-h-[250px] flex justify-center items-center">
                                {/* Discount Badge */}
