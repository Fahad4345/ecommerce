...
export default function SaleSection({
    ...
    return (
        <div className={` ${showSwiper === true ? "ml-[135px]" : "mx-[135px]"}  mt-[145px] flex flex-col gap-[40px] items-center`}>
            ...
            <div className="flex w-full justify-between items-center">
                ...
                {showNavigation && showSwiper && (
                    <div className="flex gap-[8px] mr-[135px]">
                        <button
            ...
            {showViewAll && (
                <Link href="/Pages/AllProduct"><div
