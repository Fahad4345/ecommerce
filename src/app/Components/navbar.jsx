...
export default function navbar() {
    return (
        <div className=' mt-[40px] px-[135px] pb-[16px] gap-[148px] flex border-b-[1px]  w-full border-[#000000]/30'>
            <div className='flex gap-[190px] '><div>
                ...
                <div className=' flex gap-[48px]'>
                    {["Home", "Contact", "About", "Signup"].map((nav, index) => (
                        <div key={index}><p className='font-[Poppins] text-black font-[400] text-[16px] leading-[24px] tracking-[0%]  cursor-pointer hover:underline'>{nav}</p></div>
                    ))}
            ...
            <div className='flex gap-[24px]'>
                ...
                <div className=' flex gap-[16px]'>
                    <Image src="/assets/icons/Wishlist.svg" width={32} height={32} />
                    <Image src="/assets/icons/cart.svg" width={32} height={32} />
