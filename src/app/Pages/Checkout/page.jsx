...
export default function CheckoutPage() {
    ...
    return (
        <div className=' bg-white h-full'>
            <Header />
            <Navbar />
            <div className=' mx-[135px] mt-[80px] flex'>
                <div className=' '>
                    ...
                    <div className=' flex flex-col gap-[32px] mt-[48px]'>
                        ...
                        <div className=' flex flex-col gap-[8px]'><label htmlFor="" className='font-[400] text-[16px] leading-[24px] tracking-[0%] font-[Poppins] opacity-[40%]'>First Name*</label>
                            <div className=' w-[470px] h-[50px] bg-[#F5F5F5] rounded-[4px]'><input type="text" className="w-full px-[10px] py-[10px] flex justify-center items-center" /></div></div>
                        <div className=' flex flex-col gap-[8px]'><label htmlFor="" className='font-[400] text-[16px] leading-[24px] tracking-[0%] font-[Poppins] opacity-[40%]'>Company Name</label>
                            <div className=' w-[470px] h-[50px] bg-[#F5F5F5] rounded-[4px]'><input type="text" /></div></div>
          ...
          ${selected ? "bg-[#DB4444]" : "bg-gray-200"}`}
                ...
                <div className=" ml-[173px] mt-[110px]">
                    ...
                    <button className=' bg-[#DB4444] mt-[32px] text-white px-[48px] py-[16px] rounded-[4px] font-[Poppins] font-[500] text-[16px] leading-[24px] tracking-[0%] '>Place Order</button>
                </div>
