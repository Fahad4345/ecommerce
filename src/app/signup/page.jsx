            ...
            <div className=' flex flex-row mt-[60px]  max-w-[1305px] gap-[129px]'>
                ...
                <div className=' flex flex-col gap-[48px] min-w-[371px] '>
                    ...
                    <form className=' gap-[40px]   flex flex-col '>
                        <div>
                            <input onChange={handleChange} className=' pb-[8px] w-full  border-b-[1px] border-[#00000066]  font-[Poppins] font-[400] text-[16px] leading-[24px] tracking-[0%] focus:outline-none focus:ring-0 ' placeholder=' First Name' name='Firstname' value={FormData.Firstname} type="text" />


                        </div>
                        <div>
                            <input onChange={handleChange} className=' pb-[8px] w-full  border-b-[1px] border-[#00000066]  font-[Poppins] font-[400] text-[16px] leading-[24px] tracking-[0%] focus:outline-none focus:ring-0 ' placeholder='Last Name' name='Lastname' value={FormData.Lastname} type="text" />
