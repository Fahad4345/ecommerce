                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="bg-gray-50 p-4 rounded-lg">
                                            <p className="text-sm text-gray-600">
                                                ...
                                                <span
                                                    className={`ml-2 px-2 py-1 rounded text-xs ${order.paymentStatus === "Paid"
                                ...
                                <div className="mb-8">
                                    ...
                                    <div className="grid gap-4">
                                        {order.items.map((item, idx) => (
                                            <div
                                                key={idx}
                                                className="flex items-center justify-between p-6 bg-gradient-to-r from-gray-50 to-blue-50 rounded-xl border border-gray-200 hover:border-blue-300 transition-all duration-200"
                                            >
                                ...
                                {order.orderStatus.toLowerCase() !== "cancelled" && (
                                    <div className="pt-6 border-t border-gray-200">
                                        <button
                                            ...
                                            className="px-6 py-3 border-2 border-gray-300 hover:border-red-500 hover:bg-red-50 text-gray-700 hover:text-red-700 font-semibold rounded-xl transition-all duration-200 flex items-center justify-center space-x-2"
                                        >
                                            <span>❌</span>
